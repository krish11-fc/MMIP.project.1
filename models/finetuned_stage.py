"""
models/finetuned_stage.py — Original InertialTNRD with learnable PDE scalars.
...
class FinetunedDiffusionStage(nn.Module):
    """
    One stage of inertial telegraph diffusion with learnable PDE scalars.
